    ...
    copy: {
        main: {
            files: [
                ...
                { expand: true, flatten: true, src: ['kiosk.conf'], dest: 'dist/', filter: 'isFile' },
                { expand: true, flatten: true, src: ['src/images/instructions/*'], dest: 'dist/images/instructions/', filter: 'isFile' }
            ]
        }
    },
